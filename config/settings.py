...
ALERT_WEBHOOK_SIGNING_SECRET = os.getenv("ALERT_WEBHOOK_SIGNING_SECRET", "")
ALERT_WEBHOOK_SIGNATURE_HEADER = os.getenv("ALERT_WEBHOOK_SIGNATURE_HEADER", "X-SGPV-Signature")
ALERT_WEBHOOK_TIMESTAMP_HEADER = os.getenv("ALERT_WEBHOOK_TIMESTAMP_HEADER", "X-SGPV-Timestamp")
